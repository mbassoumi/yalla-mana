       ...
       // spinnerData();
        ...
        offer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NewTrip requestTrip = new NewTrip(num, 1,1, datee, pricee, "requested", attr);
                ...
                call2.enqueue(new Callback<Trip>() {
                    ...
                    public void onResponse(Call<Trip> call, Response<Trip> response) {
                        ...
                        if (response.code() == 200) {
                            ...
                            Intent i = new Intent(RequestActivity.this, AllTripsActivity.class);
    ...
    private void spinnerData() {
        ...
        call2.enqueue(new Callback<List<Cities>>() {
            ...
            public void onResponse(Call<List<Cities>> call, Response<List<Cities>> response) {
                ...
                spinner_from.setAdapter(new ArrayAdapter<String>(RequestActivity.this, android.R.layout.simple_list_item_1, City_States));
                spinner_to.setAdapter(new ArrayAdapter<String>(RequestActivity.this, android.R.layout.simple_list_item_1, City_States));
