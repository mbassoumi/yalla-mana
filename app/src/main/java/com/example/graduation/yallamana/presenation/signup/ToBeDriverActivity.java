    ...
    private void layout1() {
        ...
        yalla_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String number =  sharedPreferences.getString("number", "noValue");
                String email =  sharedPreferences.getString("email", "noValue");
                // Do whatever here
                NewUser driverUser1 = new NewUser(name,number, email, "male",
...
//        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
         if (resultCode == RESULT_OK) {
            ...
            imagePath = getRealPathFromURIPath(targetUri, ToBeDriverActivity.this);
             if (type.equals("carl")){
    ...
    private String getRealPathFromURIPath(Uri targetUri, ToBeDriverActivity signupActivity) {
    ...
    private void moveToMyProfile() {
        ...
        Intent i = new Intent(ToBeDriverActivity.this,Drawer_List.class);
        User1 user=null;
