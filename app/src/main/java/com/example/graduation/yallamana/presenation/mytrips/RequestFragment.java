...
public class RequestFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        trips  = (List<Trip>) getArguments().getSerializable("requests");
...
//       trips = new ArrayList<>();
        ...
        RecyclerView recyclerView = (RecyclerView)getActivity(). findViewById(R.id.recycler_view8);
      //  final FloatingActionButton mFab =(FloatingActionButton)getActivity().findViewById(R.id.fab);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        tripAdapter = new TripAdapter(recyclerView, trips, getActivity(),"request");
